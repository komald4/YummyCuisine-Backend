...
user_recipe1 = UserRecipe.create(user_id: user1.id, recipe_id: recipes1.id, favorites: false, likes: false, creator: true) 
user_recipe2 = UserRecipe.create(user_id: user2.id, recipe_id: recipes2.id, favorites: false, likes: false, creator: true)
user_recipe3 = UserRecipe.create(user_id: user3.id, recipe_id: recipes3.id, favorites: false, likes: false, creator: true)
user_recipe4 = UserRecipe.create(user_id: user1.id, recipe_id: recipes2.id, favorites: true, likes: false, creator: false)
user_recipe5 = UserRecipe.create(user_id: user2.id, recipe_id: recipes3.id, favorites: false, likes: true, creator: false)
user_recipe6 = UserRecipe.create(user_id: user3.id, recipe_id: recipes1.id, favorites: true, likes: true, creator: false)